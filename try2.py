...
def generate_pdf(s_no,admission_no,name,parent_name,nationality,is_backward_communtiy,sex,dob,identification_mark,doa,std,course,medium,qualified,is_fees_paid,is_schlorshiped,dol,conduct,dot):
    fileName='output/'+str(admission_no)+'.pdf'
    pdf = canvas.Canvas(fileName,pagesize=letter)
    pdf.setTitle(str(s_no))
    ...
    pdf.drawString(300,522,f'''      {is_backward_communtiy}''')
    pdf.drawString(300,520,''': …………………………………………………………..''')

    pdf.drawString(24,495,'''5. Sex''')
    pdf.drawString(300,497,f'''      {sex}''')
    pdf.drawString(300,495,''': …………………………………………………………..''')

    pdf.drawString(24,470,'''6. Date of Birth as entered in the admission Register ''')
    pdf.drawString(24,455,'''   in figures and words''')
    pdf.drawString(300,457,f'''      {dob}''')
    pdf.drawString(300,455,''': …………………………………………………………..''')

    pdf.drawString(24,430,'''7. Personal marks of Identification''')
    pdf.drawString(300,432,f'''      {identification_mark}''')
    ...
    pdf.drawString(300,257,f'''      {is_fees_paid}''')
